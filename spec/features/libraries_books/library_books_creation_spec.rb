...
RSpec.describe "library_books creation" do
  ...
  it "can see if a book is checked out from the new book created" do
    library_1 = Library.create!(name: "Chicago Public Library",
                                public: true,
                                years_opened: 150)
    book_1 = library_1.books.create!(title: "To Kill a Mockingbird",
  ...
  it "can see if a book has not been checked out" do
    library_1 = Library.create!(name: "Chicago Public Library",
                                public: true,
                                years_opened: 150)
    book_1 = library_1.books.create!(title: "To Kill a Mockingbird",
    ...
    fill_in("book_title", with: "Milkweed")
    uncheck("a_checkbox")
    ...
    expect(page).to have_content("Milkweed")
  end
